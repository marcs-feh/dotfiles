...
export PF_INFO="title os kernel uptime pkgs memory shell palette"
export PF_COL1=1
export PF_COL3=7
...
export PLAN9="/usr/local/share/p9p"
...
printf 'Start X display server? (Y/n) '
read init_x11
if [ -z "$init_x11" ] || [ "$init_x11" = "y" ]; then
	startx
fi
